...
import com.amazonaws.services.cloudformation.model.{CancelUpdateStackRequest, CancelUpdateStackResult, ContinueUpdateRollbackRequest, ContinueUpdateRollbackResult, CreateChangeSetRequest, CreateChangeSetResult, CreateStackInstancesRequest, CreateStackInstancesResult, CreateStackRequest, CreateStackResult, CreateStackSetRequest, CreateStackSetResult, DeleteChangeSetRequest, DeleteChangeSetResult, DeleteStackInstancesRequest, DeleteStackInstancesResult, DeleteStackRequest, DeleteStackResult, DeleteStackSetRequest, DeleteStackSetResult, DeregisterTypeRequest, DeregisterTypeResult, DescribeAccountLimitsRequest, DescribeAccountLimitsResult, DescribeChangeSetRequest, DescribeChangeSetResult, DescribeStackDriftDetectionStatusRequest, DescribeStackDriftDetectionStatusResult, DescribeStackEventsRequest, DescribeStackEventsResult, DescribeStackInstanceRequest, DescribeStackInstanceResult, DescribeStackResourceDriftsRequest, DescribeStackResourceDriftsResult, DescribeStackResourceRequest, DescribeStackResourceResult, DescribeStackResourcesRequest, DescribeStackResourcesResult, DescribeStackSetOperationRequest, DescribeStackSetOperationResult, DescribeStackSetRequest, DescribeStackSetResult, DescribeStacksRequest, DescribeStacksResult, DescribeTypeRegistrationRequest, DescribeTypeRegistrationResult, DescribeTypeRequest, DescribeTypeResult, DetectStackDriftRequest, DetectStackDriftResult, DetectStackResourceDriftRequest, DetectStackResourceDriftResult, DetectStackSetDriftRequest, DetectStackSetDriftResult, EstimateTemplateCostRequest, EstimateTemplateCostResult, ExecuteChangeSetRequest, ExecuteChangeSetResult, GetStackPolicyRequest, GetStackPolicyResult, GetTemplateRequest, GetTemplateResult, GetTemplateSummaryRequest, GetTemplateSummaryResult, ListChangeSetsRequest, ListChangeSetsResult, ListExportsRequest, ListExportsResult, ListImportsRequest, ListImportsResult, ListStackInstancesRequest, ListStackInstancesResult, ListStackResourcesRequest, ListStackResourcesResult, ListStackSetOperationResultsRequest, ListStackSetOperationResultsResult, ListStackSetOperationsRequest, ListStackSetOperationsResult, ListStackSetsRequest, ListStackSetsResult, ListStacksRequest, ListStacksResult, ListTypeRegistrationsRequest, ListTypeRegistrationsResult, ListTypeVersionsRequest, ListTypeVersionsResult, ListTypesRequest, ListTypesResult, RecordHandlerProgressRequest, RecordHandlerProgressResult, RegisterTypeRequest, RegisterTypeResult, SetStackPolicyRequest, SetStackPolicyResult, SetTypeDefaultVersionRequest, SetTypeDefaultVersionResult, SignalResourceRequest, SignalResourceResult, StopStackSetOperationRequest, StopStackSetOperationResult, UpdateStackInstancesRequest, UpdateStackInstancesResult, UpdateStackRequest, UpdateStackResult, UpdateStackSetRequest, UpdateStackSetResult, UpdateTerminationProtectionRequest, UpdateTerminationProtectionResult, ValidateTemplateRequest, ValidateTemplateResult}
import com.amazonaws.services.cloudformation.waiters.AmazonCloudFormationWaiters

import java.util.concurrent.Future

object FakeAmazonCloudFormationAsync extends AmazonCloudFormationAsync {
